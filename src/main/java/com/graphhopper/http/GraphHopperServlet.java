...
public class GraphHopperServlet extends GHBaseServlet {
   ...
   /* 
    private GHPoint point1=new GHPoint(52.502963,13.288229);
    private GHPoint point2=new GHPoint(52.503751,13.303665);
   */
    ...
    public void doGet(HttpServletRequest httpReq, HttpServletResponse httpRes) throws ServletException, IOException {
    	...
    	/* List<GHPoint> infoPoints = new ArrayList<GHPoint>();
    	    infoPoints.add(point1);
    	    infoPoints.add(point2);
    	    List<GHPoint> requestPoints = infoPoints;*/
